        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="mb-16">
            ...
            <div className="text-center mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://g.page/r/CYxeuJdLuPvUEAE/review"
                target="_blank"
              ...
              <a
                href="https://www.google.com/search?q=Clutter+Free+Spaces+reviews"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-gray-500 hover:text-rose-600 font-medium"
              >
